...
public class ThisWithConstructor {
	//this() calls current constructor-->constructor chaining
	 ThisWithConstructor() {
	 ...
	 ThisWithConstructor(String str1, String str2){
		 ...
		 System.out.println("I have 1 string parameters " +str1+ " " + str2);
		 ...
		 public static void main(String[] args) {
			...
			/*1.I am inside constructor with 1  parameters
			 *2.I have no parameters
             *3.I am inside constructor with 1  parameters
             *4.I have 1 String parameters
